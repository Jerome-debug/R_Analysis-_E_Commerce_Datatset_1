...
There are a few outliers in our data on The Income colum that doesn affect our analysis
...
There is a strong negative correlation between the Daily internt usage and those indivuduals that click on Ads
...
There is a strong negative correlation between the Daily itime spent on sites and those indivuduals that click on Ads

```{R}
#calculate correlation between Ads Clicked and Area Income
cor(advertising$`Clicked on Ad`, advertising$`Area Income`)
...
```{R}
#calculate correlation between Ads clicked  and Age
cor(advertising$`Clicked on Ad`, advertising$`Age`)
...
###Recommendatations
Focus ad traffic to users aged 30 and below as they have high internet usage

Foucs on sending ads to individuals with high income as they spend more time on the sites

Send more ads to clients with high internet usage as theyre more likely to see the ads compared to the ones with less internet usaged

People aged 40 are a good client market for the ads because they alot of time on the sites
